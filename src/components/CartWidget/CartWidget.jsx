...
//Provisorio xq se que esto mas tarde vendra de la BD
  ...
  return (
    <NavLink  to={'/checkout/cart'}  className="h-9 relative inline-flex items-center px-5 py-0.5 text-sm font-bold text-center text-white bg-lime-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
